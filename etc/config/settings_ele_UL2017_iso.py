...
baseOutDir = 'results/UL2017/tnpEleIso'
...
biningDef = [
   ...
   { 'var' : 'el_pt' , 'type': 'float', 'bins': [25,28,32,35,50,100,200,500] },
...
cutBase   = 'tag_Ele_pt > 27 && abs(tag_sc_eta) < 2.17 && el_q*tag_Ele_q < 0 && passingMVA94Xwp90noisoV2==1 && passHltEle32DoubleEGWPTightGsf==1 && passEGL1SingleEGOr==1'
